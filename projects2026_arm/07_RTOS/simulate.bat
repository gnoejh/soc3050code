@echo off
REM ============================================================================
REM  07_RTOS - build, then simulate
REM
...
echo      and paste in the Notepad text: the LED bar on PB0-PB7 and
echo      buttons A (PA0) and B (PA1), as in lesson 05.
...
echo        %CD%\Main.elf
echo.
echo   6. Every second the serial monitor prints each task's share
echo      of the CPU.  Press A to change the bar's speed, B to turn
echo      the prime-hunting hog on and off, and watch the table move.
echo.
