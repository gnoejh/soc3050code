...
<svg viewBox="0 0 1020 609" role="img" aria-label="Nucleo-C031C6 headers to scale, with this lesson's pins highlighted">
  ...
  <text x="734.0" y="323.0" text-anchor="start" class="mono" font-size="13">PA5  LD4, the on-board LED (on-board)</text>
...
<svg viewBox="0 0 620 260" role="img" aria-label="Ports as register bits, with this lesson's pins marked">
  ...
  <text x="88" y="94" class="mono lbl" xml:space="preserve">PA5   out  LD4, the on-board LED</text>
  ...
  <text x="76" y="175" text-anchor="end" class="mono">GPIOB</text>
  <rect class="reg" x="88" y="153" width="29" height="34" rx="3"/>
  <text x="102.5" y="167" text-anchor="middle" class="mono lbl">15</text>
  <rect class="reg" x="120" y="153" width="29" height="34" rx="3"/>
  <text x="134.5" y="167" text-anchor="middle" class="mono lbl">14</text>
  <rect class="reg" x="152" y="153" width="29" height="34" rx="3"/>
  <text x="166.5" y="167" text-anchor="middle" class="mono lbl">13</text>
  <rect class="reg" x="184" y="153" width="29" height="34" rx="3"/>
  <text x="198.5" y="167" text-anchor="middle" class="mono lbl">12</text>
  <rect class="reg" x="216" y="153" width="29" height="34" rx="3"/>
  <text x="230.5" y="167" text-anchor="middle" class="mono lbl">11</text>
  <rect class="reg" x="248" y="153" width="29" height="34" rx="3"/>
  <text x="262.5" y="167" text-anchor="middle" class="mono lbl">10</text>
  <rect class="reg" x="280" y="153" width="29" height="34" rx="3"/>
  <text x="294.5" y="167" text-anchor="middle" class="mono lbl">9</text>
  <rect class="reg" x="312" y="153" width="29" height="34" rx="3"/>
  <text x="326.5" y="167" text-anchor="middle" class="mono lbl">8</text>
  <rect class="hifill" x="344" y="153" width="29" height="34" rx="3"/>
  <text x="358.5" y="167" text-anchor="middle" class="mono lbl">7</text>
  <text x="358.5" y="181" text-anchor="middle" class="mono">out</text>
  <rect class="hifill" x="376" y="153" width="29" height="34" rx="3"/>
  <text x="390.5" y="167" text-anchor="middle" class="mono lbl">6</text>
  <text x="390.5" y="181" text-anchor="middle" class="mono">out</text>
  <rect class="hifill" x="408" y="153" width="29" height="34" rx="3"/>
  <text x="422.5" y="167" text-anchor="middle" class="mono lbl">5</text>
  <text x="422.5" y="181" text-anchor="middle" class="mono">out</text>
  <rect class="hifill" x="440" y="153" width="29" height="34" rx="3"/>
  <text x="454.5" y="167" text-anchor="middle" class="mono lbl">4</text>
  <text x="454.5" y="181" text-anchor="middle" class="mono">out</text>
  <rect class="hifill" x="472" y="153" width="29" height="34" rx="3"/>
  <text x="486.5" y="167" text-anchor="middle" class="mono lbl">3</text>
  <text x="486.5" y="181" text-anchor="middle" class="mono">out</text>
  <rect class="hifill" x="504" y="153" width="29" height="34" rx="3"/>
  <text x="518.5" y="167" text-anchor="middle" class="mono lbl">2</text>
  <text x="518.5" y="181" text-anchor="middle" class="mono">out</text>
  <rect class="hifill" x="536" y="153" width="29" height="34" rx="3"/>
  <text x="550.5" y="167" text-anchor="middle" class="mono lbl">1</text>
  <text x="550.5" y="181" text-anchor="middle" class="mono">out</text>
  <rect class="hifill" x="568" y="153" width="29" height="34" rx="3"/>
  <text x="582.5" y="167" text-anchor="middle" class="mono lbl">0</text>
  <text x="582.5" y="181" text-anchor="middle" class="mono">out</text>
  <text x="88" y="207" class="mono lbl" xml:space="preserve">PB7..PB0  out  LED bar, one bit per LED</text>
  <text x="310" y="252" text-anchor="middle" class="lbl">in = MODER 00 · out = 01 · afN = 10 with AFR = N · an = 11 - lesson 05, slides 4-5</text>
</svg>
```
