/*
 * os.c - shared copy of lesson 07's kernel.  Link with LIBS=os.
 *
 * Lesson 07 is where this file is written and taken apart; keep this copy in
 * step with 07_RTOS/os.c.  From lesson 08 on it is infrastructure.
 *
