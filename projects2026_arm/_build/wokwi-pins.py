...
NOTES = {
    "PA0":  "Button A in lessons 05, 07, 08. Also ADC channel 0 - analog pin A0 on the header.",
    "PA1":  "Button B in lessons 05, 07, 08 (EXTI line 1 in 05). Line 1 is shared by PA1, PB1, PC1... - only one can interrupt.",
    "PA2":  "USART2 TX, alternate function 1 - the serial monitor that printf writes to. Taken.",
    "PA3":  "USART2 RX - the serial monitor, and lesson 08's input. Taken.",
    "PA4":  "Potentiometer in lesson 09: ADC channel 4 (analog pin A2).",
    "PA5":  "LD4, the on-board green LED, and also SPI1 SCK (AF0, Arduino D13) - in lesson 09 LD4 flickers with the SPI clock.",
    "PA6":  "Servo PWM in lesson 06: TIM3_CH1, alternate function 1.",
    "PA7":  "HC-SR04 echo in lesson 06 (TIM14_CH1, AF4); SPI1 MOSI to the MAX7219 in lesson 09 (AF0). Same pin, different AF per lesson.",
    "PA8":  "HC-SR04 trigger in lesson 06: a plain GPIO output, 10 us pulse.",
    ...
    "PB8":  "I2C1 SCL in lesson 09 (AF6, open drain) - the MPU6050.",
    "PB9":  "I2C1 SDA in lesson 09 (AF6, open drain) - the MPU6050.",
    "PC13": "User button B1 on the real board - NOT modelled by Wokwi. Lesson 05 Lab Part 7 wires an external button here (EXTI line 13, EXTICR code 2).",
    ...
    "PB0":  "LED bar, bit 0, in lessons 04-08; MAX7219 chip select in lesson 09. Note there is no plain PB0 - see the trap list.",
    "PB1":  "LED bar, bit 1, in lessons 04-08.",
    "PB2":  "LED bar, bit 2, in lessons 04-08.",
    "PB3":  "LED bar, bit 3, in lessons 04-08.",
    "PB4":  "LED bar, bit 4, in lessons 04-08.",
    "PB5":  "LED bar, bit 5, in lessons 04-08.",
    "PB6":  "LED bar, bit 6, in lessons 04-08.",
    "PB7":  "LED bar, bit 7, in lessons 04-08.",
