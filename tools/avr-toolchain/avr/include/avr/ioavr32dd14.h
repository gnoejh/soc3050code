...
{
    PORTMUX_LUT1_DEFAULT_gc = (0x00<<1),  /* INn: -, PC1, PC2 OUT: PC3 */
    PORTMUX_LUT1_ALT1_gc = (0x01<<1)  /* INn: -, PC1, PC2 OUT: - */
} PORTMUX_LUT1_t;
...
typedef enum PORTMUX_SPI0_enum
{
    ...
    PORTMUX_SPI0_ALT3_gc = (0x03<<0),  /* MOSI: PA0, MISO: PA1, SCK: -, SS: PC1 */
    PORTMUX_SPI0_ALT4_gc = (0x04<<0),  /* MOSI: PD4, MISO: PD5, SCK: PD6, SS: PD7 */
    PORTMUX_SPI0_ALT5_gc = (0x05<<0),  /* MOSI: -, MISO: PC1, SCK: PC2, SS: PC3 */
...
typedef enum PORTMUX_TCA0_enum
{
    ...
    PORTMUX_TCA0_PORTC_gc = (0x02<<0),  /* WOn: -, PC1, PC2, PC3, -, - */
...
{
    PORTMUX_TCD0_DEFAULT_gc = (0x00<<0),  /* Not connected to any pins */
    PORTMUX_TCD0_ALT4_gc = (0x04<<0)  /* WOx: -, -, PD4, PD5 */
} PORTMUX_TCD0_t;
...
{
    PORTMUX_USART1_DEFAULT_gc = (0x00<<3),  /* TxD: -, RxD: PC1, XCK: PC2, XDIR: PC3 */
