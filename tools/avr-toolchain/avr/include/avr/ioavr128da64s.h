...
#  define _AVR_IOXXX_H_ "ioavr128da64s.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_AVR128DA64S_H_INCLUDED
#define _AVR_AVR128DA64S_H_INCLUDED
...
{
    PORTMUX_EVOUTB_DEFAULT_gc = (0x00<<1),  /* EVOUT: PB2 */
    PORTMUX_EVOUTB_ALT1_gc = (0x01<<1)  /* EVOUT: PB7 */
} PORTMUX_EVOUTB_t;
...
typedef enum PORTMUX_EVOUTC_enum
{
    ...
    PORTMUX_EVOUTC_ALT1_gc = (0x01<<2)  /* EVOUT: PC7 */
} PORTMUX_EVOUTC_t;
...
{
    PORTMUX_EVOUTE_DEFAULT_gc = (0x00<<4),  /* EVOUT: PE2 */
    PORTMUX_EVOUTE_ALT1_gc = (0x01<<4)  /* EVOUT: PE7 */
} PORTMUX_EVOUTE_t;

/* Event Output F select */
typedef enum PORTMUX_EVOUTF_enum
{
    PORTMUX_EVOUTF_DEFAULT_gc = (0x00<<5)  /* EVOUT: PF2 */
} PORTMUX_EVOUTF_t;

/* Event Output G select */
typedef enum PORTMUX_EVOUTG_enum
{
    PORTMUX_EVOUTG_DEFAULT_gc = (0x00<<6),  /* EVOUT: PG2 */
    PORTMUX_EVOUTG_ALT1_gc = (0x01<<6)  /* EVOUT: PG7 */
} PORTMUX_EVOUTG_t;
...
typedef enum PORTMUX_TCB4_enum
{
    ...
    PORTMUX_TCB4_ALT1_gc = (0x01<<4)  /* WO: PC6 */
} PORTMUX_TCB4_t;
...
typedef enum PORTMUX_USART2_enum
{
    ...
    PORTMUX_USART2_ALT1_gc = (0x01<<4),  /* TxD: PF4, RxD: PF5, XCK: -, XDIR: - */
...
#endif /* #ifdef _AVR_AVR128DA64S_H_INCLUDED */
