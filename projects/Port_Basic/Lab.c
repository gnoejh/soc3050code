/*
 * =============================================================================
 * PORT PROGRAMMING - HANDS-ON LAB EXERCISES
 * =============================================================================
 * ATmega128 Educational Framework - Lab Session
 *
 * OBJECTIVE: Collective hands-on experience with port I/O operations
 * DURATION: 90 minutes
 * DIFFICULTY: Beginner
 *
 * STUDENTS WILL:
 * - Practice LED control with various patterns
 * - Implement button-controlled interactions
 * - Create bit manipulation challenges
 * - Work on team-based exercises
 * - Debug common port I/O issues
 *
 * HARDWARE REQUIRED:
 * - ATmega128 board
 * - 8 LEDs on PORTB (PB0-PB7)
 * - 4 buttons on PORTD (PD4-PD7)
 * - Optional: Buzzer on PC0
 *
 * =============================================================================
 */
