/*
 * Keypad Calculator - Interactive Calculator System
 * ATmega128 Educational Framework
 *
 * LEARNING OBJECTIVES:
 * - Build practical keypad application
 * - Implement state machine for user interface
 * - Handle multi-digit number entry
 * - Practice arithmetic operations and display formatting
 *
 * HARDWARE SETUP:
 * Same as previous keypad projects:
 * - Rows (PA0-PA3) as outputs
 * - Columns (PA4-PA7) as inputs with pull-ups
 *
