/*
 * Timer Basic - Educational Example
 * ATmega128 Educational Framework
 *
 * LEARNING OBJECTIVES:
 * - Understand hardware timer operation
 * - Learn timer prescaler configuration
 * - Practice precise timing generation
 * - Master timer overflow and compare modes
 *
 * HARDWARE SETUP:
 * - LEDs on PORTB for visual timing indication
 * - Optional: oscilloscope on OC2 pin for waveform analysis
 */
