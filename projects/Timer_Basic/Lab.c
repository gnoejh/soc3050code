/*
 * =============================================================================
 * TIMER PROGRAMMING - HANDS-ON LAB EXERCISES
 * =============================================================================
 * ATmega128 Educational Framework - Lab Session
 *
 * OBJECTIVE: Master timer/counter operations through practical exercises
 * DURATION: 90 minutes
 * DIFFICULTY: Intermediate to Advanced
 *
 * STUDENTS WILL:
 * - Measure frequencies with input capture
 * - Generate PWM signals for LED dimming
 * - Create event schedulers
 * - Build digital stopwatch
 * - Implement tone generation
 *
 * HARDWARE REQUIRED:
 * - ATmega128 board
 * - LEDs on PORTB
 * - Buzzer on PC0
 * - Button on PD4 for stopwatch
