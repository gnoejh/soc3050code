/*
 * LCD Character Display (HD44780) - 4-bit Mode
 * ATmega128 Educational Framework
 *
 * LEARNING OBJECTIVES:
 * - Interface with 16x2 or 20x4 character LCD
 * - Understand 4-bit mode communication protocol
 * - Practice timing and initialization sequences
 * - Display text, numbers, and special characters
 *
 * HARDWARE SETUP (4-bit mode):
 * LCD Pin → ATmega128 Pin
 * -------------------------
 * VSS (1)  → GND
 * VDD (2)  → +5V
 * V0  (3)  → Contrast adjustment (potentiometer)
 * RS  (4)  → PG0
 ...
 * D6  (13) → PG4
 * D7  (14) → PG5
 * A   (15) → +5V (backlight anode, with resistor)
