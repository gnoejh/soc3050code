 ...
 *
 * LEARNING OBJECTIVES:
 * - Interface with DS1307 RTC via I2C
 * - Understand BCD (Binary-Coded Decimal) encoding
 * - Implement time/date read/write operations
 * - Practice I2C register-based communication
 *
 * HARDWARE SETUP:
 * - DS1307 Real-Time Clock IC
 * - PD0 (SCL) → Pin 6 (SCL) of DS1307
 * - PD1 (SDA) → Pin 5 (SDA) of DS1307
 * - 4.7K pull-up resistors on SDA and SCL
 * - 32.768 kHz crystal on DS1307 pins 1-2
 * - 3V battery backup on Pin 3 (VBAT)
 * - Pin 4 (GND) → GND, Pin 8 (VCC) → +5V
 *
