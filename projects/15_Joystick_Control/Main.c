/*
 * Joystick Control - Educational Example
 * ATmega128 Educational Framework
 *
 * LEARNING OBJECTIVES:
 * - Learn analog joystick interface and ADC usage
 * - Understand coordinate system mapping
 * - Practice threshold-based digital control from analog input
 * - Master multi-channel ADC for X/Y axis reading
 *
 * HARDWARE SETUP:
 * - Analog joystick connected to ADC channels 0 (X) and 1 (Y)
 * - Joystick button connected to digital input (optional)
 * - LEDs on PORTB for direction indication
 * - UART for position monitoring and calibration
 * - Optional: Servo motors for joystick-controlled movement
 */
