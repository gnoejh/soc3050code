 ...
 * - Handle different data formats (raw, scaled, multi-byte)
 * - Practice sensor calibration and data processing
 * - Implement sensor fusion concepts
 *
 * HARDWARE SETUP:
 * - PD0 (SCL) → I2C Clock Line (shared)
 * - PD1 (SDA) → I2C Data Line (shared)
 ...
 * - DS18B20 (I2C): Temperature Sensor (0x48-0x4F)
 * - Generic I2C sensors
 */
