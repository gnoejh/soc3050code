@echo off
REM Build script for PWM Motor DC Control project (REFINED)
REM Now uses _pwm.h library for professional motor control

echo Building PWM Motor DC Control (Refined with _pwm.h)...
