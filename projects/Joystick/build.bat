@echo off
REM Build script for Joystick Control project (REFINED)
REM Now uses enhanced _adc.h library for improved ADC readings

echo Building Joystick Control (Refined with _adc.h)...
