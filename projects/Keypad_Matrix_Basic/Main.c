/*
 * Keypad Matrix Scanning - 4x4 Keypad Interface
 * ATmega128 Educational Framework
 *
 * LEARNING OBJECTIVES:
 * - Understand matrix scanning technique
 * - Implement row/column scanning algorithm
 * - Handle multiple key detection
 * - Practice efficient polling vs interrupt methods
 *
 * HARDWARE SETUP (4x4 Matrix Keypad):
 * Keypad Layout:
 *   [1] [2] [3] [A]
 *   [4] [5] [6] [B]
 *   [7] [8] [9] [C]
