 ...
 *
 * LEARNING OBJECTIVES:
 * - Understand servo motor PWM requirements (50Hz, 1-2ms pulses)
 * - Generate precise pulse widths using 16-bit Timer1
 * - Control servo position (0-180 degrees)
 * - Practice multi-servo coordination
 *
 * HARDWARE SETUP:
 * - Servo motors connected to PB5 (OC1A), PB6 (OC1B)
 * - Servos powered from external 5-6V supply
 * - Common ground between ATmega128 and servo supply
 ...
 * - Neutral: 1.5ms (90°)
 * - Dead band: Typically ±5° for cheap servos
 */
