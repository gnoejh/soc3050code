/*
 * I2C/TWI Master Basic Communication
 * ATmega128 Educational Framework
 *
 * LEARNING OBJECTIVES:
 * - Understand I2C protocol (Start, Stop, ACK, NACK)
 * - Master TWI (Two-Wire Interface) register configuration
 * - Implement 7-bit device addressing
 * - Practice read/write operations with I2C devices
 *
 * HARDWARE SETUP:
 * - ATmega128 as I2C Master
 * - PD0 (SCL) - I2C Clock (with 4.7K pull-up to VCC)
 * - PD1 (SDA) - I2C Data (with 4.7K pull-up to VCC)
