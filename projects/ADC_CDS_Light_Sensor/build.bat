@echo off
REM Build script for CDS Light Sensor project (REFINED)
REM Now uses enhanced _adc.h library for stable light readings

echo Building CDS Light Sensor (Refined with _adc.h)...
