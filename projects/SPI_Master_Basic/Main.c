...
void display_main_menu(void)
{
    ...
    puts_USART1("??  SPI MASTER BASIC - ATmega128        ??r\n");
    ...
    puts_USART1("  [2] Loopback Test (MOSI?묺ISO)\r\n");
