/*
 * =============================================================================
 * SPI MASTER BASIC - HANDS-ON LAB EXERCISES
 * =============================================================================
 * ATmega128 Educational Framework - Lab Session
 *
 * OBJECTIVE: Master SPI communication protocol and peripheral control
 * DURATION: 75 minutes
 * DIFFICULTY: Intermediate
 *
 * STUDENTS WILL:
 * - Configure ATmega128 as SPI master controller
 * - Interface with SPI devices using different modes
 * - Implement device selection and timing control
 * - Debug SPI communication and signal integrity
 * - Create multi-device SPI bus management
 *
 * HARDWARE REQUIRED:
 * - ATmega128 board
