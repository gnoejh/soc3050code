/*
 * config.h - Matrix Keypad Scanning
 * SOC3050 ATmega128 Educational Framework, 2026 AVR edition
 *
 * Focus: row and column scanning of a 4x4 keypad without dedicated hardware
 */
...
/* This lesson implements its own character-LCD driver, so it does
