...
__attribute__((unused)) static void demo_05_register_constraints(void)
{
    ...
    while (1)
    {
        ...
        // PROGMEM only applies to objects with static storage; on an
        // automatic array the attribute is ignored and lpm would read
        // flash at a RAM address.
        static const uint8_t flash_data[] PROGMEM = {1, 2, 3, 4, 5};
...
int main(void)
{
     ...
     * - Calculate how many NOP instructions needed for 1us, 10us, 100us @ 16MHz
