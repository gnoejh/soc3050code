    ...
    if (Test-Path $configFile) {
        ...
        if ($content -match "#define\s+F_CPU") {
            ...
            if ($fcpuMatch.Success) {
                ...
                if ($fcpuValue -eq 7372800) {
                    Add-TestResult "CPU Frequency" "PASS" "F_CPU correctly set to 7.3728MHz"
            ...
            Add-TestResult "CPU Frequency" "FAIL" "F_CPU not defined" "Add #define F_CPU 7372800UL"
        }
